...
if len(sys.argv) != 5:
    ...
    sys.stderr.write('\tpython df_to_matrix.py TRAIN_INPUT TEST_INPUT TRAIN_OUTPUT TEST_OUTPUT\n')
    sys.exit(1)
...
def save_matrix(df, matrix, output):
    ...
    msg = 'The output matrix {} size is {}, type is {} and data type is {}\n'
    sys.stderr.write(msg.format(output, result.shape, type(result), result.dtype))
